...
(function() {
  var $field, $form, $item, $opt, Field, Form, Item, Option, helper, __slice = [].slice, __bind = function(fn,
      me) {
    return function() {
  ...
  helper = {
    fill : function(src, target, klass) {
      ...
      div.append("<label for='" + id + "'>" + (f.label || '') + "</label>").append(
          $(f.toHTML()).attr("id", id)).append("<br />");
      return div.children();
    }, getHtmlFields : function(html) {
      html = $(html);
      return __slice.call(html.find("input")).concat(__slice.call(html.find("select")),
          __slice.call(html.find("textarea")));
    }
  };
  ...
  Form = (function() {
    ...
    Form.prototype.toXML = function() {
      ...
      xml = $build("x", {
        xmlns : "jabber:x:data", type : this.type
      });
      if (this.title) {
  ...
  Field = (function() {
    ...
    function Field(opt) {
      ...
      if (opt) {
        ...
        this["var"] =
            ((_ref1 = opt["var"]) != null ? _ref1.toString() : void 0) || "_no_var_was_defined_";
    ...
    Field.prototype.toJSON = function() {
      ...
      json = {
        type : this.type, "var" : this["var"], required : this.required
      };
      if (this.desc) {
        json.desc = this.desc;
      }
    ...
    Field.fromHTML = function(html) {
      ...
      f = new Field({
        type : type, "var" : html.attr("name"), required : html.attr("required") === "required"
      });
      switch (type) {
        case "list-multi":
        case "list-single":
  ...
  Option = (function() {
    ...
    Option.fromXML = function(xml) {
      return new Option({
        label : ($(xml)).attr("label"), value : ($(xml)).text()
      });
    };

    Option.fromHTML = function(html) {
      return new Option({
        value : ($(html)).attr("value"), label : ($(html)).text()
      });
    };
  ...
  Strophe.x = {
    Form : Form, Field : Field, Option : Option, Item : Item
  };
